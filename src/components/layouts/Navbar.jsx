...
const Navbar = () => {
  ...
  return (
    <section>
      <div className="fixed z-[100] flex items-center flex-row-reverse lg:flex-row border-b top-0 left-0 border-slate-200 justify-between w-full px-10 py-2 bg-navtheme">
        <div className="logo">
          <a href="#">
      ...
      <div className="w-full z-0 hidden pt-16 shadow-md lg:flex items-center justify-end bg-navtheme space-x-4">
